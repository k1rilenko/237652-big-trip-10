...
render(tripMain, templateInfo(), `afterbegin`);
const tripMenu = document.querySelector(`.trip-main__trip-controls`);
render(tripMenu, templateMenu(), `afterbegin`);
render(tripMenu, templateFilter(), `beforeend`);
const tripBody = document.querySelector(`.trip-events`);
render(tripBody, templateSort(), `beforeend`);
render(tripBody, templateForm(), `beforeend`);
render(tripBody, templateContainer(), `beforeend`);
const tripContainer = document.querySelector(`.trip-days`);
render(tripContainer, templateDay(), `beforeend`);
const tripEventsList = document.querySelector(`.trip-events__list`);
new Array(3).fill(``).forEach(() => render(tripEventsList, templateCard(), `beforeend`));
